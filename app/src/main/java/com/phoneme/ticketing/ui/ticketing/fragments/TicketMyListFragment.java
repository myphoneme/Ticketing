...
public class TicketMyListFragment extends Fragment implements TicketListAdapterNew.OnItemClickListener {
...
//        });
        ...
        //commented for my tickets. There in tickets
...
//        });
        ...
        //getTicketData();//Get all tickets
        getMyTicketData();//Get tickets of a user
    }
...
//    }
    public void download(String url) {
        ...
        new TicketMyListFragment.DownloadFile().execute(url, filename);
    }
