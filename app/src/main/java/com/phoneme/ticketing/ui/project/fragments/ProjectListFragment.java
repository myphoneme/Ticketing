...
import com.phoneme.ticketing.ui.project.adapter.ProjectListAdapter2;
import com.phoneme.ticketing.ui.project.adapter.ProjectListEngagementAdapter;
...
public class ProjectListFragment extends Fragment implements ProjectListAdapter2.OnItemClickListener{
...
//        });
    ...
    private void setData(List<ProjectModel> projectModelList){
        ...
        //adapter=new ProjectListEngagementAdapter(getContext(),projectModelList,this);
        adapter=new ProjectListAdapter2(getContext(),projectModelList,this,item_color);
...
//        Bundle args2= TicketListFragmentDirections.navTicketingAction().getArguments();
        args2.putString("project_id",this.projectModelList.get(position).getId());
//Below 2 code commented on mar19 because it is used for project engagement. for roject list something else
        //will used
        NavController navController = Navigation.findNavController(getActivity(), R.id.nav_host_fragment);
        navController.navigate(R.id.nav_project_detail_only_action,args2);
    }
