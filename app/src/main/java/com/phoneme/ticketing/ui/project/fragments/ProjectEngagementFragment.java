...
public class ProjectEngagementFragment extends Fragment implements ProjectListEngagementAdapter.OnItemClickListener {
    ...
    private ProjectListEngagementAdapter adapter;
...
//        });
    ...
    private void setData(List<ProjectModel> projectModelList){
       // adapter=new ProjectListAdapter(getContext(),projectModelList,this);
        ...
        adapter=new ProjectListEngagementAdapter(getContext(),projectModelList,this,item_color);
